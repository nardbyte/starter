 ...
 */
   ...
   /**
     ...
     * @return eval
     */
    function _get_mr_template()
    {
        if($this->template_ms == true ) {
            $this->_eval(base64_decode('ZWNobyAnPCEtLSBodHRwOi8vd3d3Lm1hcmNvZmJiLmNvbS5hci8gLS0+PCEtLSBQb3dlcmVkIGJ5IE1vdmllIFNjcmlwdCAtLT4nOw=='));
        }
